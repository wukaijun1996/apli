...
Revision ID: 9eb82c6482dd
Revises: 1ae54241ddbb
Create Date: 2022-03-26 00:08:28.391253
...
revision = '9eb82c6482dd'
down_revision = '1ae54241ddbb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('dept', sa.Column('addr', sa.String(length=100), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('dept', 'addr')
